...
from Login.forms.login.form_login_designer import FormLoginDesigner
from Login.forms.registration.form import FormRegister
from MenuSideBar.formularios.form_maestro_design import FormularioMaestroDesign
...
class FormLogin(FormLoginDesigner):
    ...
    def isPassword(self, password: str, user: Auth_User):
        ...
        if(password == b_password):
            ...
            FormularioMaestroDesign().mainloop()
        else:
            messagebox.showerror(
